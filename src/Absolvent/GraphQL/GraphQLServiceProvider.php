<?php namespace Absolvent\GraphQL;

use Illuminate\Support\ServiceProvider;
use Absolvent\GraphQL\Console\MutationMakeCommand;
use Absolvent\GraphQL\Console\QueryMakeCommand;
use Absolvent\GraphQL\Console\TypeMakeCommand;
